				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
						<div class="well no-padding">
									<form action="${pageContext.request.contextPath}/register" method="post" id="contact-form" class="smart-form client-form">
										<fieldset>
											
												<section>
													<label class="label"> Nome</label> <label class="input">
														<i class="icon-append fa fa-envelope-o"></i> <input
														type="text" name="etnia.nome" id="login" />
													</label>
												</section>
												<br/>
<!-- 												<section > -->
<!-- 													<label class="label"> Situacao </label> <select -->
<!-- 														name="etnia.ativa"> -->
