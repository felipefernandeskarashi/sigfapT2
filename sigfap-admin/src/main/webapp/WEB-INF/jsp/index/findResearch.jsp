...
<head>
<meta charset="utf-8">
<title>sigfap | Buscar Pesquisador</title>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
					<div class="well no-padding">
						<form action="${pageContext.request.contextPath}/displayResearch"
							method="post" id="smart-form-register"
							class="smart-form client-form">
							<header> Buscar Pesquisador </header>
							...
							<fieldset>
								...
								<section>
									<label class="label">Curso</label> <label class="input">
										<input type="text" name="research.curso">
									</label>
								</section>

								<section>
									<label class="label">Tipo</label> <label class="input">
										<input type="text" name="research.tipo">
									</label>
								</section>
