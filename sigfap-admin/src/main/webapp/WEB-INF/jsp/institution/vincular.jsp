...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
						<div class="well no-padding">
							<form action="${pageContext.request.contextPath}/vincular-instituicao1" method="post" id="smart-form-register" class="smart-form client-form">
								<header>
									Vincular Instituicao
								</header>
								<fieldset>
									
									<label class="label">InstituiÁıes Sugeridas</label>
									<select name="instS" id="teste">
  											<c:forEach var="instituicaoS" items="${instituicoesS}">
  												<option value=<c:out  value="${instituicaoS.id}"/>><c:out value="${instituicaoS.nome}"/>	
												</option>
											</c:forEach >   
									</select>
									
									<label class="label">InstituiÁıes</label>
									<select name="inst" id="teste">
									...
									<input type="text" name="institution.dependenciaAdm" value="7"style="display:none"> 
							    </fieldset>
								<footer>
 ...
 <div id="left">
            ...
            <h2>[User content</h2>
            <p>In these terms and conditions, ‚Äúyour user content‚Äù means material (including without limitation text, images, audio material, video material and audio-visual material) that you submit to this website, for whatever purpose.</p>
            ...
            <h2>No warranties</h2>
            <p>This website is provided ‚Äúas is‚Äù without any representations or warranties, express or implied.  [NAME] makes no representations or warranties in relation to this website or the information and materials provided on this website.</p>
