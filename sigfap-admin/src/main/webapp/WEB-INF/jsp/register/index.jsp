...
<html lang="en-us" id="extr-page">
	...
	<body id="login">
		...
		<header id="header">
			...
			<span id="extr-page-header-space"> <span class="hidden-mobile">Already registered?</span> <a href="${pageContext.request.contextPath}" class="btn btn-danger">Sign In</a> </span>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
						<div class="well no-padding">
							...
							<form action="${pageContext.request.contextPath}/register1" method="post" id="smart-form-register" class="smart-form client-form" onsubmit="return validarSenha();">
								<header>
								...
								<fieldset>
									...
									<section>
										...
										<label class="input"> <i class="icon-append fa fa-lock"></i>
											<input type="password" name="user.senha" id="password">
