				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
						<div class="well no-padding">
							<form action="${pageContext.request.contextPath}/unit/exibir" method="post" id="smart-form-register" class="smart-form client-form">
								<header>
									Buscar Unidade
								</header>
								<fieldset>
									...
									<section>
										...
										<input type="text" name="unit.nome" size="50">
									</section>
									
									<section>
										<label class="label">InstituiÁ„o</label>
										<input type="text" name="instNome" size="50">
									</section>
									
									<section>
										<label class="label">CNPJ</label>
										<input type="text" name="" id="unit.cnpj" size="50">
									</section>
									
									
									<section>
										<label class="label">Tipo de OrdenaÁ„o</label>
										<select name="tipoOrdenacao">
											<option value="1">Nome Unidade</option>
											<option value="2">InstituiÁ„o</option>
										</select>
									</section>
										<label class="label">SituaÁ„o</label>
