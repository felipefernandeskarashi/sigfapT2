...
<html lang="pt-BR" id="extr-page">
	<head>
		...
		<!-- #CSS Links -->
		<!-- Basic Styles -->
		<link rel="stylesheet" type="text/css" media="screen" href="${pageContext.request.contextPath}/static/css/bootstrap.min.css">
		<link rel="stylesheet" type="text/css" media="screen" href="${pageContext.request.contextPath}/static/css/font-awesome.min.css">
		<!-- SmartAdmin Styles : Please note (smartadmin-production.css) was created using LESS variables -->
		<link rel="stylesheet" type="text/css" media="screen" href="${pageContext.request.contextPath}/static/css/smartadmin-production.min.css">
		<link rel="stylesheet" type="text/css" media="screen" href="${pageContext.request.contextPath}/static/css/smartadmin-skins.min.css">
		...
		<link rel="stylesheet" type="text/css" media="screen" href="${pageContext.request.contextPath}/static/css/demo.min.css">
		<!-- #FAVICONS -->
		<link rel="shortcut icon" href="${pageContext.request.contextPath}/static/img/favicon/favicon.ico" type="image/x-icon">
		<link rel="icon" href="${pageContext.request.contextPath}/static/img/favicon/favicon.ico" type="image/x-icon">
		<!-- #GOOGLE FONT -->
		<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Open+Sans:400italic,700italic,300,400,700">
		<!-- #APP SCREEN / ICONS -->
		<!-- Specifying a Webpage Icon for Web Clip 
			 Ref: https://developer.apple.com/library/ios/documentation/AppleApplications/Reference/SafariWebContent/ConfiguringWebApplications/ConfiguringWebApplications.html -->
		<link rel="apple-touch-icon" href="${pageContext.request.contextPath}/static/img/splash/sptouch-icon-iphone.png">
		<link rel="apple-touch-icon" sizes="76x76" href="${pageContext.request.contextPath}/static/img/splash/touch-icon-ipad.png">
		<link rel="apple-touch-icon" sizes="120x120" href="${pageContext.request.contextPath}/static/img/splash/touch-icon-iphone-retina.png">
		<link rel="apple-touch-icon" sizes="152x152" href="${pageContext.request.contextPath}/static/img/splash/touch-icon-ipad-retina.png">
		...
		<link rel="apple-touch-startup-image" href="${pageContext.request.contextPath}/static/img/splash/ipad-landscape.png" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:landscape)">
		<link rel="apple-touch-startup-image" href="${pageContext.request.contextPath}/static/img/splash/ipad-portrait.png" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:portrait)">
		<link rel="apple-touch-startup-image" href="${pageContext.request.contextPath}/static/img/splash/iphone.png" media="screen and (max-device-width: 320px)">
	...
	<body id="login" onLoad="setDisabled()">
		...
		<header id="header">
			...
			<span id="extr-page-header-space"> <span class="hidden-mobile"></span> <a href="${pageContext.request.contextPath}/" class="btn btn-danger">Home</a> </span>
		</header>
				...
				<div class="row">
						...
						<div class="hero">
							<div class="pull-left login-desc-box-l">
								...
								<div class="login-app-icons">
									<a href="${pageContext.request.contextPath}/static/javascript:void(0);" class="btn btn-danger btn-sm">Frontend Template</a>
									<a href="${pageContext.request.contextPath}/static/javascript:void(0);" class="btn btn-danger btn-sm">Find out more</a>
								</div>
							</div>
							
							<img src="${pageContext.request.contextPath}/static/img/demo/iphoneview.png" alt="" class="pull-right display-image" style="width:210px">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
						<div class="well no-padding">
							<form action="${pageContext.request.contextPath}/inserir-unidade1" method="post" id="smart-form-register" class="smart-form client-form">
								<header>
								...
								<fieldset>
									...
									<section>
										<label class="label">Nome Unidade</label>
										<input type="text" name="unit.nome" value="${unidade.nome}" size=50 required="required">
									</section>
									
									<section>
										<label class="label">CNPJ</label>
										<input type="text" name="unit.cnpj" value="${unidade.cnpj}" size=50 required="required">
									</section>
									
									<section>
										<label class="label">E-Mail</label>
										<input type="text" name="unit.email" value="${unidade.email}" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Telefone</label>
										<input type="text" name="telephone.numero" value="${telefone.numero}"size=50 required="required">
									</section>
									
									<section>
										<label class="label">Rua</label>
										<input type="text" name="address.rua" value="${endereco.rua}" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Numero</label>
										<input type="text" name="address.numero" value="${endereco.numero}" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Complemento</label>
										<input type="text" name="address.complemento" value="${endereco.complemento}" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Bairro</label>
										<input type="text" name="address.bairro" value="${endereco.bairro}" size=50 required="required">
									</section>
									
									<section>
										<label class="label">CEP</label>
										<input type="text" name="address.cepZip" value="${endereco.cepZip}" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Situação</label>
										<select name="unit.ativa">
											<option value="1">Ativa</option>
											<option value="0">Inativa</option>
										</select>
									</section>
									<h2>Cadastro Dirigente</h2> <br/>
									<section>
										<label class="label">Nome Diregente</label>
										<input type="text" name="representative.nome" value="${representante.nome}" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Cargo</label>
										<input type="text" name="representative.cargo" value="${representante.cargo}" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Matrícula</label>
										<input type="text" name="representative.matricula" value="${representante.matricula}" size=50 required="required">
									</section>
									
									<section>
										<label class="label">RG</label>
										<input type="text" name="representative.rg" value="${representante.rg}"size=50 required="required">
									</section>
									
									<section>
										<label class="label">Órgão Emissor</label>
										<input type="text" name="representative.rgEmissao" value="${representante.rgEmissao}"size=50 required="required">
									</section>
									
									<section>
										<label class="label">Data de Emissão</label>
										<input type="Date" name="representative.rgDataEmissao" value="${representante.rgDataEmissao}" size=50 required="required">
									</section>
									
									<section>
										<label class="label">CPF</label>
										<input type="text" name="representative.cpf" value="${representante.cpf}" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Telefone</label>
										<input type="text" name="telephoneRepresentative.numero" value="${telefoneR.numero}"size=50 required="required">
									</section>
									...
									<section>
										<label class="label">Rua</label>
										<input type="text" name="addressRepresentative.rua" value="${enderecoR.rua}" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Número</label>
										<input type="text" name="addressRepresentative.numero" value="${enderecoR.numero}"size=50 required="required">
									</section>
									
									<section>
										<label class="label">Complemento</label>
										<input type="text" name="addressRepresentative.complemento" value="${enderecoR.complemento}"size=50 required="required">
									</section>
									
									<section>
										<label class="label">Bairro</label>
										<input type="text" name="addressRepresentative.bairro" value="${enderecoR.bairro}"size=50 required="required">
									</section>
									
									<section>
										<label class="label">CEP</label>
										<input type="text" name="addressRepresentative.cepZip" value="${enderecoR.cepZip}"size=50 required="required">
									</section>
						...
						<ul class="list-inline text-center">
							<li>
								<a href="${pageContext.request.contextPath}/static/javascript:void(0);" class="btn btn-primary btn-circle"><i class="fa fa-facebook"></i></a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/static/javascript:void(0);" class="btn btn-info btn-circle"><i class="fa fa-twitter"></i></a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/static/javascript:void(0);" class="btn btn-warning btn-circle"><i class="fa fa-linkedin"></i></a>
							</li>
						</ul>
					</div>
				</div>
...
Contractology supply a wide variety of commercial legal documents, such as <a href="${pageContext.request.contextPath}/static/#">template data protection statements</a>.
</p>
	 ...
	 <a href="${pageContext.request.contextPath}/static/#">terms and conditions</a> set out on 
	 <a href="${pageContext.request.contextPath}/static/#">SmartAdmin.com</a>.  You must retain the credit 
	 ...
	 use of the template.</strong></p>
		...
		<script src="${pageContext.request.contextPath}/static/js/plugin/pace/pace.min.js"></script>
	    <!-- Link to Google CDN's jQuery + jQueryUI; fall back to local -->
	    <script src="//ajax.googleapis.com/ajax/libs/jquery/2.0.2/jquery.min.js"></script>
		<script> if (!window.jQuery) { document.write('<script src="${pageContext.request.contextPath}/static/js/libs/jquery-2.0.2.min.js"><\/script>');} </script>
	    <script src="//ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/jquery-ui.min.js"></script>
		<script> if (!window.jQuery.ui) { document.write('<script src="${pageContext.request.contextPath}/static/js/libs/jquery-ui-1.10.3.min.js"><\/script>');} </script>
		...
		<!-- JQUERY VALIDATE -->
		<script src="${pageContext.request.contextPath}/static/js/plugin/jquery-validate/jquery.validate.min.js"></script>
		
		<!-- JQUERY MASKED INPUT -->
		<script src="${pageContext.request.contextPath}/static/js/plugin/masked-input/jquery.maskedinput.min.js"></script>
		...
		<script language="javascript" type="text/javascript">
			function Hab() {
				if (document.getElementById("inst_estr").checked==true) {
