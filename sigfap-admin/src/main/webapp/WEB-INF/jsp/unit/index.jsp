							...
							<form action="${pageContext.request.contextPath}/inserir-unidade1" method="post" id="smart-form-register" class="smart-form client-form">
								...
								<fieldset>
									...
									<section>
										...
										<input type="text" name="unit.nome" size=50 required="required">
									</section>
									
									<section>
										<label class="label">CNPJ</label>
										<input type="text" name="unit.cnpj" size=50 required="required">
									</section>
									
									<section>
										<label class="label">E-Mail</label>
										<input type="text" name="unit.email" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Telefone</label>
										<input type="text" name="telephone.numero" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Rua</label>
										<input type="text" name="address.rua" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Numero</label>
										<input type="text" name="address.numero" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Complemento</label>
										<input type="text" name="address.complemento" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Bairro</label>
										<input type="text" name="address.bairro" size=50 required="required">
									</section>
									
									<section>
										<label class="label">CEP</label>
										<input type="text" name="address.cepZip" size=50 required="required">
									</section>
									...
									<section>
										...
										<input type="text" name="representative.nome" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Cargo</label>
										<input type="text" name="representative.cargo" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Matrícula</label>
										<input type="text" name="representative.matricula" size=50 required="required">
									</section>
									
									<section>
										<label class="label">RG</label>
										<input type="text" name="representative.rg" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Órgão Emissor</label>
										<input type="text" name="representative.rgEmissao" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Data de Emissão</label>
										<input type="Date" name="representative.rgDataEmissao" size=50 required="required">
									</section>
									
									<section>
										<label class="label">CPF</label>
										<input type="text" name="representative.cpf" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Telefone</label>
										<input type="text" name="telephoneRepresentative.numero" size=50 required="required">
									</section>
									...
									<section>
										<label class="label">Rua</label>
										<input type="text" name="addressRepresentative.rua" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Número</label>
										<input type="text" name="addressRepresentative.numero" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Complemento</label>
										<input type="text" name="addressRepresentative.complemento" size=50 required="required">
									</section>
									
									<section>
										<label class="label">Bairro</label>
										<input type="text" name="addressRepresentative.bairro" size=50 required="required">
									</section>
									
									<section>
										<label class="label">CEP</label>
										<input type="text" name="addressRepresentative.cepZip" size=50 required="required">
									</section>
